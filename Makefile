...
all: get-onts get-mappings gen-boomer-input data/output/combo.owl ptable boomer
...
.PHONY: ptable
ptable: data/input/combined_sssom.tsv
	sssom ptable $< -o data/output/combined_ptable.tsv

boomer:
	boomer --ptable data/output/combined_ptable.tsv\
		   --ontology data/output/combo.owl \
		   --prefixes data/output/prefix.yaml \
		   --output data/output/boomer_output \
		   --window-count 20 \
		   --runs 100
...
dirs: data/ data/input/ data/tmp/ data/output data/output/boomer_output
data/input/ data/tmp/ data/output/ data/output/boomer_output:
	mkdir -p $@
